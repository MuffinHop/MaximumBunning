...
namespace Unitycoding
{
    public class ModuleManagerWindow : EditorWindow
    {
        ...
        [MenuItem("Tools/Unitycoding/Module Manager", false, -100)]
        ...
        private void DrawItem(ModuleItem item) {
            ...
            GUILayout.Space(9f);
            GUILayout.Label(item.Icon, GUILayout.Width(32), GUILayout.Height(32));
        ...
        {
            using (UnityWebRequest w = UnityWebRequest.Get("http://unitycoding.com/Modules.txt"))
            {
                yield return w.SendWebRequest();
        ...
        {
            GUILayout.Space(3f);
            m_SearchString = SearchField(m_SearchString, GUILayout.Width(m_SidebarRect.width - 20));
            GUILayout.Space(3f);
        }
